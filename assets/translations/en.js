...
t.add("SSL Port", "SSL Port", "messages", "en");
...
t.add("Parent Service", "Parent Service", "messages", "en");
t.add("Child Service", "Child Service", "messages", "en");
t.add("This form describes the main service linked to this application.", "This form describes the main service linked to this application.", "messages", "en");
t.add("This is an additional service that depends on the parent service.", "This is an additional service that depends on the parent service.", "messages", "en");
t.add("Service Name", "Service Name", "messages", "en");
t.add("(optional)", "(optional)", "messages", "en");
t.add("API Key is optional.", "API Key is optional.", "messages", "en");
t.add("Use socket", "Use socket", "messages", "en");
t.add("Socket Path", "Socket Path", "messages", "en");
t.add("All these fields are optional.", "All these fields are optional.", "messages", "en");
t.add("Paths", "Paths", "messages", "en");
t.add("Subdomain", "Subdomain", "messages", "en");
t.add("Backup Path", "Backup Path", "messages", "en");
t.add("Root URL", "Root URL", "messages", "en");
t.add("Database Path", "Database Path", "messages", "en");
t.add("Caddyfile Path", "Caddyfile Path", "messages", "en");
t.add("Remove Service", "Remove Service", "messages", "en");
})(Translator);
