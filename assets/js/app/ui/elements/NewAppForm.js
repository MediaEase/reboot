...
class NewAppForm {
    ...
    initialize() {
        ...
        document.querySelector('.add-service-btn').addEventListener('click', () => {
            ...
            if (currentIndex >= 2) {
                alert('You can only add up to two services.');
                return;
            }
    ...
    addServiceForm(index) {
        ...
        const serviceTitle = index === 0 ? 'Parent Service' : 'Child Service';
        const serviceHelper = index === 0 ? 'This form describes the main service linked to this application.' : 'This is an additional service that depends on the parent service.';
        newFormWrapper.innerHTML = `
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_name" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Service Name</label>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_apikey" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">API Key (optional)</label>
                <p class="text-xs text-left text-gray-500 mt-1">API Key is optional.</p>
                <p id="error-service_${index}_apikey" class="mt-2 text-xs text-red-600 dark:text-red-400" style="display: none;"></p>
            </div>
            <div class="flex items-center justify-between mb-6">
                <label for="service_${index}_use_socket" class="block text-sm font-bold text-gray-500 dark:text-gray-400">Use Socket</label>
            ...
            <div class="port-fields">
                <div class="flex space-x-2 mb-6">
                    <div class="relative w-1/2" data-twe-input-wrapper-init data-twe-validate="input">
                        ...
                        <label for="service_${index}_web_port" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Web Port</label>
                    ...
                    <div class="relative w-1/2" data-twe-input-wrapper-init data-twe-validate="input">
                        ...
                        <label for="service_${index}_ssl_port" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">SSL Port</label>
            ...
            <div class="socket-fields hidden">
                <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                    ...
                    <label for="service_${index}_socket" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Socket Path</label>
                    <p id="error-service_${index}_socket" class="mt-2 text-xs text-red-600 dark:text-red-400" style="display: none;"></p>
                </div>
            </div>
            <h4 class="text-md font-semibold mb-1 text-gray-800 dark:text-gray-200">Paths</h4>
            <p class="text-xs text-gray-500 mb-4 -mt-2">All these fields are optional.</p>
            <div class="flex justify-between items-center mb-4" data-twe-input-wrapper-init data-twe-validate="input">
                <label for="service_${index}_subdomain" class="block text-sm font-bold mb-2 text-left cursor-pointer text-gray-500 dark:text-gray-400">Subdomain</label>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_config_path" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Config Path (optional)</label>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_database_path" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Database Path (optional)</label>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_caddyfile_path" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Caddyfile Path (optional)</label>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_backup_path" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Backup Path (optional)</label>
            ...
            <div class="relative mb-6" data-twe-input-wrapper-init data-twe-validate="input">
                ...
                <label for="service_${index}_root_url" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Root URL (optional)</label>
