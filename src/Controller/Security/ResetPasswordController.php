...
use App\Form\User\Reset\ChangePasswordFormType;
use App\Form\User\Reset\ResetPasswordRequestFormType;
...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('', name: 'app_forgot_password_request', defaults: ['_feature' => 'forgot_password'])]
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        return $this->render('pages/security/reset_password/request.html.twig', [
            'requestForm' => $form,
            'settings' => $settings,
        ]);
    }
     ...
     */
    #[Route('/check-email', name: 'app_check_email', defaults: ['_feature' => 'forgot_password'])]
     ...
     */
    #[Route('/reset/{token}', name: 'app_reset_password', defaults: ['_feature' => 'forgot_password'])]
